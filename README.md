...
- All assignments are menu-driven.
- Test cases are stored inside the corresponding `tests/` directory.
- Performance measurements are reported in the assignment-specific README files where applicable.
