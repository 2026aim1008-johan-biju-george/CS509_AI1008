...
void generate_unweighted_graph(int V, int E, int source, bool directed=false){
    string filename = "tests/graph_" + to_string(V) + ".txt"; // input filename
...
void generate_unweighted_tests(){
    generate_unweighted_graph(10, 20, 0);
    generate_unweighted_graph(100, 200, 0);
    generate_unweighted_graph(10000, 20000, 0);
    generate_unweighted_graph(50000, 100000, 0);
    generate_unweighted_graph(100000, 200000, 0);
}