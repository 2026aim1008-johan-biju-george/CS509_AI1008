...
void generate_weighted_graph(string algorithm, int V, int E, int source, bool directed, bool allow_negative){
    ...
    for(int u=0;u<V && edges<E;u++){
        ...
        int weight;
        if(allow_negative){
            weight = (rand() % 21) - 10; // weights -> [-10...10]
        }
        else{
...
void generate_weighted_tests(){
    generate_weighted_graph("bf", 10, 20, 0, true, true);
    generate_weighted_graph("bf", 100, 200, 0, true, false);
    generate_weighted_graph("bf", 10000, 20000, 0, true, false);
    generate_weighted_graph("bf", 50000, 100000, 0, true, false);
    generate_weighted_graph("bf", 100000, 200000, 0, true, false);
}